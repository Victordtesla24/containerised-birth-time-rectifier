// This module is a complete replacement for ExtensionUtilities.js in three-mesh-bvh
// It avoids importing BatchedMesh which doesn't exist in our Three.js version
...
// Define BatchedMesh as null since it doesn't exist in this Three.js version
console.warn('BatchedMesh not available in this version of Three.js - using fallback implementation');
const BatchedMesh = null;
...
export function acceleratedRaycast( raycaster, intersects ) {
  ...
  if ( this.isBatchedMesh && BatchedMesh !== null ) {
...
export function computeBatchedBoundsTree( index = - 1, options = {} ) {
  ...
  if (BatchedMesh === null) {
    console.warn('BatchedMesh not available, cannot compute batched bounds tree');
    return null;
  }
