...
# Create router
geocoding_router = APIRouter(tags=["geocoding"])
...
@geocoding_router.get("/geocode", response_model=GeocodeResponse)
async def geocode(query: str = Query(..., description="Location to geocode")):
    """
