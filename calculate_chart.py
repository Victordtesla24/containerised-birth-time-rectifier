...
def main():
    ...
    # Initialize calculator with custom settings
    calculator = AstroCalculator(ayanamsa=args.ayanamsa, node_type=args.node_type)
    ...
    chart_data = calculator.calculate_chart(birth_date, latitude, longitude, house_system=house_system)
