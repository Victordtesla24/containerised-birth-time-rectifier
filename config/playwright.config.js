...
module.exports = defineConfig({
  ...
  /* Define test tags for critical path tests */
  ...
  use: {
    ...
    launchOptions: {
      slowMo: 50,
      headless: false, // Keep headed mode for debugging
  ...
  /* Configure projects for browsers - focus on Chromium only */
  projects: [
    {
      name: 'chromium',
      use: {
        ...
        launchOptions: {
          headless: false, // Keep for visual debugging in local development
          executablePath: getExecutablePath(),
          args: [
            '--disable-dev-shm-usage',
            '--disable-gpu',
    ...
    // Keep mobile testing which also appears to be passing
    {
      name: 'mobile-chrome',
      use: {
        ...devices['Pixel 5'],
    ...
    /* Comment out other browsers for now to focus on Chromium
    {
      name: 'firefox',
